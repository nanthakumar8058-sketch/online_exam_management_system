...
import { UserPlus, Users, Mail, GraduationCap, Briefcase, Fingerprint, X, Zap, Trash2, Search, ShieldAlert, Check, AlertCircle, Building2 } from 'lucide-react';
...
const OrgMembers = () => {
    ...
    const [formData, setFormData] = useState({ name: '', email: '', role: 'student', employeeId: '', registerNumber: '', department: '' });
    ...
    const handleAddMember = async (e) => {
        ...
        try {
            ...
            setShowModal(false);
            setFormData({ name: '', email: '', role: 'student', employeeId: '', registerNumber: '', department: '' });
            fetchMembers();
        } catch (err) {
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex flex-wrap gap-4 text-xs text-slate-400 font-bold">
                                    ...
                                    {member.department && <span className="flex items-center gap-2 text-brand-500"><Building2 size={12} /> {member.department.name}</span>}
                                </div>
                            </div>
                        </div>
                        <button
                    ...
                    <div className="bg-white rounded-[64px] w-full max-w-2xl p-16 shadow-3xl animate-in zoom-in-95 duration-300 relative overflow-hidden">
                        ...
                        <form onSubmit={handleAddMember} className="space-y-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <select
                                    className="w-full bg-slate-50 border-2 border-transparent rounded-[24px] py-4 px-6 focus:bg-white focus:border-brand-600 outline-none transition-all font-bold text-slate-900 appearance-none"
